    ...
    <main ref={containerRef} className="bg-black text-white">
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="aspect-[4/3] mb-6 overflow-hidden rounded-lg">
                  <Image
                    src={`/placeholder.svg?height=600&width=800&text=${encodeURIComponent(feature.title)}`}
                    alt={feature.title}
                    width={800}
                    height={600}
      ...
      <section className="relative h-[50vh] md:h-[80vh] overflow-hidden">
        <motion.div style={{ y: y2 }} className="absolute inset-0">
          <Image
            src="/placeholder.svg?height=1080&width=1920&text=Concrete%20Excellence"
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <motion.div style={{ y: y3 }} className="absolute inset-0 z-0">
          <Image
            src="/placeholder.svg?height=1080&width=1920&text=Start%20Your%20Project"
